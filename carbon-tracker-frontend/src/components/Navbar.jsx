...
function Navbar() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("theme") || "carbonLight";
    document.documentElement.setAttribute("data-theme", savedTheme);

    const themeToggle = document.querySelector(".theme-controller");
    if (themeToggle) {
      themeToggle.checked = savedTheme === "carbonDark"; // 👈 Sync toggle with theme

      themeToggle.addEventListener("change", (e) => {
        const theme = e.target.checked ? "carbonDark" : "carbonLight";
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li>
              <Link to="/emissioncalculation">Emission Calculation</Link>
            </li>
            <li>
